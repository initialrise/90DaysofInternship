...
import CustomDatePicker from "./components/MyDatePicker";
  ...
  return (
    <main className="flex flex-1 flex-col items-center bg-[#161722] min-h-screen text-white font-josefin text-[18px] gap-[20px] ">
      ...
      <div className="text-container flex flex-col gap-[20px] z-10 mt-[50px]">
        ...
        <form
          className="todo-input flex bg-todocolor  justify-between "
        ...
        >
          <input
            ...
            name="todo"
            id="todo"
            className="bg-todocolor w-[420px] px-[30px] py-[15px] text-primary peer"
